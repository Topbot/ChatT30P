    ...
    public sealed class BlogCulture
    {
        ...
        public BlogCulture(CultureInfo cultureInfo, ResourceType resourceType)
        {
            ...
            if (resourceType == ResourceType.Admin)
            {
                ...
                {
                    var filePath =
                        HostingEnvironment.MapPath(System.IO.Path.Combine("~/App_Data", "labels.txt"));
                ...
                {
                    Trace.Write("Error loading admin labels from App_Data/labels.txt " + ex);
                }
            }
            else
            {
        ...
        {
            var translation = Translate(resourceLabelKey, null, cultureInfo);
        ...
        /// The translate.
        /// </returns>
        public static string Translate(string text, string defaultValue = null, CultureInfo culture = null)
        {
            if (culture == null)
            {
                culture = new CultureInfo("ru-RU");
            }
            var resource = HttpContext.GetGlobalResourceObject("labels", text, culture);
